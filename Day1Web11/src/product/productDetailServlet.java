...
import productservice.productserviceimpl.Product;
import productservice.productserviceimpl.ProductListServiceImpl;
import productservice.productserviceimpl.ProductServiceImpl;
...
//		Product product = service.getProduct(2);
		...
		Product product = (Product) req.getAttribute("productDetail");		
		toProductDetail(resp, product);
		//super.doGet(req, resp);
	}

	private void toProductDetail(HttpServletResponse resp, Product product)
			throws IOException {
		...
		out.println("					<a href=login>达内电子商务门户</a> → 产品明细");
		out.println("				</td>");
		out.println("			</tr>");
		out.println("		</table>");
		out.println("");
...
//		writeProductList(out);
		...
		out.println("				");
		out.println("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
		out.println("				"+product.getCategorydescription());
		out.println("				</td>");
		out.println("			</tr>");
		out.println("			<tr>");
