...
public class shoppingCart extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("					<a href=login>达内电子商务门户</a> →<img border=\"0\" src=\"images/dog.gif\" width=\"19\" height=\"18\"><b>购物清单</b>");
		out.println("				</td>");
		out.println("			</tr>");
		out.println("		</table>");
		out.println("		<br>");
	...
	public void writeShoppingCartLine(PrintWriter out) 
	{
		try {
		...
		try {
			...
			rs = stmt.executeQuery("select * "
					+ "from orderline join product on orderline.productid = product.productid ");
			int i = 1;
			while(rs.next())
			{
				out.println("			<tr>");
